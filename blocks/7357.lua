...

{
    ...
    cannon={
        damage=340282353463979561713663,
        power=1,
        projectileSize=5,
        roundsPerSec=3600,
        recoil=0,
...

{
    ...
    cannon={
        ...
        explosive=FRAG_FINAL,
        color=0x02bbdf,
        fragment={damage=1000,range=300,muzzleVel=2555,color=0x02bbdf,pattern=ABSOLUTE|CONSTANT,projectileSize=0.4,spread=1.57,roundsPerBurst=1,
        fragment={damage=1000,range=300,muzzleVel=2555,color=0x02bbdf,pattern=ABSOLUTE|CONSTANT,projectileSize=0.4,spread=-1.57,roundsPerBurst=1,
        fragment={damage=1000,range=300,muzzleVel=2555,color=0x02bbdf,pattern=ABSOLUTE|CONSTANT,projectileSize=0.4,spread=-1.57,roundsPerBurst=1,
        fragment={damage=1000,range=300,muzzleVel=2555,color=0x02bbdf,pattern=ABSOLUTE|CONSTANT,projectileSize=0.4,spread=1.57,roundsPerBurst=1,
        fragment={damage=1000,range=300,muzzleVel=2555,color=0x02bbdf,pattern=ABSOLUTE|CONSTANT,projectileSize=0.4,spread=1.57,roundsPerBurst=1,
